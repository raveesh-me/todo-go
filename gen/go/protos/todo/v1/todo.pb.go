...
const file_protos_todo_v1_todo_proto_rawDesc = "" +
	"\n" +
	"\x19protos/todo/v1/todo.proto\x12\atodo.v1\"J\n" +
	"\x04Todo\x12\x0e\n" +
	...
	"\x12DeleteTodoResponse2\xdf\x01\n" +
	"\vTodoService\x12E\n" +
	"\n" +
	...
	"\n" +
	"DeleteTodo\x12\x1a.todo.v1.DeleteTodoRequest\x1a\x1b.todo.v1.DeleteTodoResponseB2Z0github.com/raveesh-me/todo/gen/go/protos/todo/v1b\x06proto3"

var (
	file_protos_todo_v1_todo_proto_rawDescOnce sync.Once
	file_protos_todo_v1_todo_proto_rawDescData []byte
)

func file_protos_todo_v1_todo_proto_rawDescGZIP() []byte {
	file_protos_todo_v1_todo_proto_rawDescOnce.Do(func() {
		file_protos_todo_v1_todo_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_protos_todo_v1_todo_proto_rawDesc), len(file_protos_todo_v1_todo_proto_rawDesc)))
	})
	return file_protos_todo_v1_todo_proto_rawDescData
}

var file_protos_todo_v1_todo_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_protos_todo_v1_todo_proto_goTypes = []any{
...
var file_protos_todo_v1_todo_proto_depIdxs = []int32{
	...
	4, // 6: todo.v1.TodoService.ListTodos:output_type -> todo.v1.ListTodosResponse
	6, // 7: todo.v1.TodoService.DeleteTodo:output_type -> todo.v1.DeleteTodoResponse
...
func file_protos_todo_v1_todo_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_protos_todo_v1_todo_proto_rawDesc), len(file_protos_todo_v1_todo_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
