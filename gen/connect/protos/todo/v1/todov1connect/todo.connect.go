...
func NewTodoServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TodoServiceClient {
	...
	todoServiceMethods := todov1.File_protos_todo_v1_todo_proto.Services().ByName("TodoService").Methods()
	return &todoServiceClient{
		createTodo: connect.NewClient[todov1.CreateTodoRequest, todov1.CreateTodoResponse](
			httpClient,
...
type todoServiceClient struct {
	createTodo *connect.Client[todov1.CreateTodoRequest, todov1.CreateTodoResponse]
...
func (c *todoServiceClient) CreateTodo(ctx context.Context, req *connect.Request[todov1.CreateTodoRequest]) (*connect.Response[todov1.CreateTodoResponse], error) {
...
func (UnimplementedTodoServiceHandler) CreateTodo(context.Context, *connect.Request[todov1.CreateTodoRequest]) (*connect.Response[todov1.CreateTodoResponse], error) {
